...
#    for season, sname in zip([[12, 1, 2],[6, 7, 8]], ['DJF','JJA']):
    for season, sname in zip([[6,7,8],[12, 1, 2]], ['JJA' ,'DJF']):
      ...
      df_w_n['wind_80'] = df_w_n.apply(interpWindHeight, axis=1, args=([y_hpa, season, datai, dataf]))
      df_w_p['wind_80'] = df_w_p.apply(interpWindHeight, axis=1, args=([y_hpa, season, datai, dataf]))
      ...
      df_shf_n.to_csv('teste_shf_n_future_2040_JJA.csv')
      df_shf_p.to_csv('teste_shf_p_future_2040_JJA.csv')
      df_deltaT_n.to_csv('teste_deltaT_n_future_2040_JJA.csv')
      df_deltaT_p.to_csv('teste_deltaT_p_future_2040_JJA.csv')
...
def interpWindHeight(row, y_hpa, months, yeari, yearf):
...
#  year = int(dd[0:4])
  ...
  model_heights = calc_height(months, yeari, yearf, y_hpa)
#  print(model_heights)
